...
with c2:
    coord_dec = st.text_input("Dec  —  decimal degrees or DD:MM:SS", value=st.session_state['coord_ra_dec'], help="Must be J2000, but fairly liberal. Enter something sensible and astropy will try its best")
with c3:
