...
with c8:
    resolve = st.button("Resolve coordinates", "Stuff", help='Attempts to find the coordinates of the named object (equatorial only, J2000)')

# Experimental name resolver
if resolve == True:
    try:
        coords = SkyCoord.from_name(name_tag)
        st.write(coords.ra, coords.dec)
    except:
        pass
