...
with st.sidebar:
    ...
    vrot = st.number_input("Rotation speed v$_{\rm rot}$ [km/s]", value=15.0, min_value=1.0, step=1.0, format="%.1f", help='Rotation speed after correcting the measurements for inclination and whatnot')
