...
with st.sidebar:
    ...
    Ropt = st.number_input("Optical radius R$_{\rm opt}$ [kpc]", value=1.175, min_value=0.01, step=0.05, format="%.3f", help='HI detections are usually unresolved, so the optical radius can be used to estimate the original HI extent in these cases')
